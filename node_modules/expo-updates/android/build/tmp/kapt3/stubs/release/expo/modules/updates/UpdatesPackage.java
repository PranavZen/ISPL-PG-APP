...
public final class UpdatesPackage implements expo.modules.core.interfaces.Package {
    ...
    @java.lang.Override()
    @org.jetbrains.annotations.NotNull()
    public java.util.List<expo.modules.core.interfaces.ApplicationLifecycleListener> createApplicationLifecycleListeners(@org.jetbrains.annotations.NotNull()
    android.content.Context context) {
        return null;
    }
    
    private final boolean isRunningAndroidTest() {
        return false;
    }
